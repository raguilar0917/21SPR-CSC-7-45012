...
string AI(char rr,char rw){
    ...
    static bool firstTwo = false;//checks if we found the position of the first two
    static bool dupe = false;//checks if the first two numbers are duplicates
    static  string otherTwo = "00";
    static string finalGuess = "0000";//final 
    static int pos = 0;//position of the confirmed numbers
    static bool sameNum = false;
    static int bad_pos=0;//keeps track of all the numbers nut in code
    static char badNums[10];//hols all the bad numbers
    static string confirmedCols = "0000"; //holds all the correct numbers in order
    ...
    /**
     * 
     * Guesses from 0 to 9 it will submit each number 4 times
     * this help find the correct colors and the number of repetition
     * 
     */
    if(guess == 0){
        confirmedCols = "0000";
    ...
    /**
     * 
     *Checks if we found the two correct positions if so
     * enter the endgame 
     * 
     */
    ...
    if(firstTwo){
        ...
        // Guess 10 
        //submits all known color
        if(guess == 10){
            sGuess = confirmedCols;
        }
        //splits up the known numbers
        //first 2 elements leave in guess
        // other 2 save
        if(guess == 11){
        ...
        //switch the first 2 in the previous guess
        if(guess == 12){
        ...
        //spreads the two numbers to the 0th  and 3rd element
